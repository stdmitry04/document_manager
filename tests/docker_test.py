...
try:
    ...
    URLCREATEUSERclear = "http://users-service:9000/clear"
    URLDOCCREATEclear = "http://document-service:9001/clear"
    URLDOCSEARCHclear = "http://search-service:9002/clear"
    URLLOGclear = "http://logging-service:9003/clear"
    ...
    URLCREATEUSER = "http://users-service:9000/create_user"
    URLLOGIN = "http://users-service:9000/login"
    URLDOCCREATE = "http://document-service:9001/create_document"
    URLDOCEDIT = "http://document-service:9001/edit_document"
    URLDOCSEARCH = "http://search-service:9002/search"
    URLLOG = "http://logging-service:9003/view_log"
    ...
    solution = {"status": 1,
                "jwt": 'eyJhbGciOiAiSFMyNTYiLCAidHlwIjogIkpXVCJ9.eyJ1c2VybmFtZSI6ICJqYW1lcyJ9.d5425b8034f430475313408dc6494622c8f1a373a16275c46d44f47d8d35fd52'}
    for key in solution:
    ...
    CREATEDOCPARAMS = {'filename': 'a.txt', 'body': 'I will test project 3 better than I tested project 2',
                       'groups': json.dumps({'group1': 'instructors'})}
    ...
    expected_dict = {'status': 1, 'data': {'filename': 'a.txt', 'owner': 'james', 'last_mod': 'abigail', 'total_mod': 2,
    ...
    r_log = requests.get(url=URLLOG, params=LOGPARAMS, headers={
        'Authorization': 'eyJhbGciOiAiSFMyNTYiLCAidHlwIjogIkpXVCJ9.eyJ1c2VybmFtZSI6ICJqYW1lcyJ9.d5425b8034f430475313408dc6494622c8f1a373a16275c46d44f47d8d35fd52'})
    log_data = r_log.json()

    log_dict = {1: {'event': 'document_creation', 'user': 'james', 'filename': 'a.txt'},
